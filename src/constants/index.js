...
import { stratifyImages, zevenzImages, devoverflowImages, nextlevelfoodImages, topologyImages, aiStudioImages, nexushostImages, awsImages, blockchainImages } from '../assets/projects'
...
const featuredProjects = [
  ...
  {
    name: "DevOverflow – Developer Community Platform",
    overline: "Featured Project",
    description: "Built a full-stack developer Q&A and collaboration platform inspired by StackOverflow. Features multi-provider OAuth (Google, GitHub, Facebook) via Clerk, real-time global search, job board with filtering, community hub, tag explorer, and a fully custom dark/light theme system — all rendered server-side with Next.js 15 and Turbopack.",
    tags: ["Next.js 15", "TypeScript", "Tailwind CSS 4", "React 19", "Turbopack"],
    image: devoverflowImages[0],
    images: devoverflowImages,
    github: "https://github.com/Ahtesham-Shah999/devoverflow.git",
    live: null,
    category: "Full-Stack & Web",
  },
  {
    name: "NextLevel Food – Community Recipe Platform",
    overline: "Featured Project",
    description: "Built a community-driven food sharing platform with Server Components, Suspense streaming, and Server Actions. Features SQLite database with better-sqlite3, custom image picker with drag-and-drop, XSS-sanitized user content, Zod schema validation, and dynamic slug-based meal detail pages — fully SSR with Next.js 15.",
    tags: ["Next.js 15", "React 19", "SQLite", "Server Actions", "Zod"],
    image: nextlevelfoodImages[0],
    images: nextlevelfoodImages,
    github: "https://github.com/Ahtesham-Shah999/DeployFoodproject.git",
    live: null,
    category: "Full-Stack & Web",
  },
  {
    ...
    overline: "Featured Project",
    description: "A highly customized, interactive 3D WebGL experience featuring topographical data rendering and precision typography. Built with Three.js and Vite, featuring custom @font-face rules injected directly into the HTML <style> head and native DOM manipulation for high performance.",
    tags: ["WebGL", "Three.js", "JavaScript", "CSS3"],
    image: topologyImages[0],
    images: topologyImages,
  ...
  },
  {
    ...
    overline: "Featured Project",
    description: "An AI-powered studio to automatically synthesize human-like speech from text to generate complete audiobooks seamlessly. Deployed generative AI pipeline as versioned FastAPI REST endpoint for zero-shot voice synthesis.",
    tags: ["Python", "TTS", "Machine Learning", "FastAPI"],
    image: aiStudioImages[0],
    images: aiStudioImages,
    github: "https://github.com/Ahtesham-Shah999/AI-Powered-Audiobook-Studio",
    live: null,
    category: "AI & Machine Learning",
  },
  {
    name: "NexusHost Enterprise Landing Page",
    overline: "Featured Project",
    description: "A highly complex, pixel-perfect frontend landing page designed to mimic premium domain registrars and web hosting enterprise platforms. Built with Vanilla HTML, CSS, and DOM manipulation, showcasing complex CSS grids, flexbox layouts, SVG animations, and responsive interactive elements natively.",
    tags: ["HTML", "CSS", "Web Design", "Vanilla JS"],
    image: nexushostImages[0],
    images: nexushostImages,
  ...
  },
  {
    ...
    overline: "Featured Project",
    description: "Automated the provisioning of AWS infrastructure using Terraform and Ansible. Set up VPC, EC2, RDS, and load balancers with high availability. Created Jenkins CI/CD pipeline for automated deployments.",
    tags: ["Terraform", "AWS", "DevOps", "CI/CD"],
    image: awsImages[0],
    images: awsImages,
    github: "https://github.com/Ahtesham-Shah999/aws-infra-automation-terraform.git",
    live: null,
  ...
  },
  {
    ...
    tags: ["Node.js", "Blockchain", "React"],
    image: blockchainImages[0],
    images: blockchainImages,
    github: "https://github.com/Ahtesham-Shah999/Blockchain_AMS.git",
    live: null,
